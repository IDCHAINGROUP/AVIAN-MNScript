#!/bin/bash
# Avianitecoin Masternode Setup Script V3.1.0 for Ubuntu 16.04
#
...
cd ~/.avianitecoin && https://github.com/IDCHAINGROUP/AVIANITE/releases/download/v3.1.0/bootstrap.zip
